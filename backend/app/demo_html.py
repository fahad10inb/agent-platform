    ...
    en: {
      ...
      tour: {
        real_estate: [
          ...
          "My budget's around 95k a year, moving next month — paying cash",
          "What about the 3-bedroom in JVC?",
          "Let's view the 2-bed. Can I do Thursday at 4pm?",
          "I'm Omar Haddad, 0501234567",
          "Perfect. Could a human agent call me about the paperwork too?",
        ],
        general: [
    ...
    ar: {
      ...
      tour: {
        real_estate: [
          ...
          "ميزانيتي حوالي ٩٥ ألف بالسنة، ناوي أنتقل الشهر الجاي، والدفع كاش",
          "وش عندكم بـ ٣ غرف في JVC؟",
          "تمام، أبي أعاين شقة الغرفتين. ممكن الخميس الساعة ٤؟",
          "أنا عمر حداد، رقمي 0501234567",
