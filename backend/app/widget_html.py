...
<style>
  ...
  *{box-sizing:border-box; -webkit-tap-highlight-color:transparent;}
  ...
  #send{width:46px;height:46px;flex:none;border:none;border-radius:14px;cursor:pointer; display:grid; place-items:center;
    background:linear-gradient(135deg,var(--g1),var(--g2)); box-shadow:0 8px 20px rgba(99,102,241,.4); transition:transform .12s,opacity .15s;}
