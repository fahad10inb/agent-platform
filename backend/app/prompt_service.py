...
def build_system_prompt(business: dict) -> str:
    ...
    behavior = (
        ...
        "that SAME turn with their REAL name and number exactly as given — never a "
        "placeholder like 'caller', 'unknown' or 'not provided'. A promise of "
        "follow-up without the actual capture_lead call loses the customer. "
