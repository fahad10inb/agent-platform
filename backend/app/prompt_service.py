...
def build_system_prompt(business: dict) -> str:
    ...
    voice = (
        ...
        "ENTIRELY in natural Gulf Arabic — translate every listing detail, feature and "
        "amenity into Arabic too (never leave English like 'chiller free', 'handover "
        "ready' or 'community view' sitting inside an Arabic sentence); keep only genuine "
        "proper nouns such as area and building names in their usual form. Never mix "
        "stray English words into an Arabic reply. If they write in English, reply in "
        "English. Mirror them and switch if they switch. "
